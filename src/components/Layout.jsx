...
const Layout = ({ children, activeSection, setActiveSection, openMap }) => {
        ...
        <div className="relative flex justify-center">
          ...
          <button
            ...
            className="lg:hidden absolute -right-2 top-2 text-yellow-400 bg-[#1f1f1f]
                       p-2 rounded-lg border border-yellow-400/30 shadow-md"
          >
  ...
  `}
        >
          ...
          <a href="mailto:ady1ova178@gmail.com" className="flex items-start gap-4 hover:text-yellow-400 transition">
          ...
          <a href="tel:+996755080929" className="flex items-start gap-4 hover:text-yellow-400 transition">
          ...
          <div onClick={() => openMap(coords)} className="flex items-start gap-4 cursor-pointer hover:text-yellow-400 transition">
